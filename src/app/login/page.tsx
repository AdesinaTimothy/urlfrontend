      ...
      <div className="max-w-md w-full bg-gray-900 rounded-xl shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <input
            ...
            required
            className="w-full px-4 placeholder:text-sm py-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <input
            type="password"
